...
namespace GT
{
    ...
    bool SoundAsset_Vorbis::Load(const char* absolutePath, easyvfs_context* pVFS)
    {
        ...
        {
            GT::Engine::SoundStreamer_Vorbis streamer(m_dataInfo.pData, m_dataInfo.sizeInBytes);
