...
#include <GTGE/Graphics/GraphicsModelObject.hpp>
...
namespace GT
{
    ...
    bool GraphicsModelObject::Initialize(const GraphicsAssetResource_Model* pModelResource, GraphicsWorld* pGraphicsWorld, const glm::vec4 &position, const glm::quat &rotation, const glm::vec4 &scale)
    {
    ...
    void GraphicsModelObject::SetTransform(const glm::vec4 &position, const glm::quat &rotation, const glm::vec4 &scale)
    {
