...
#ifndef GT_AudioEngine_OpenAL
#define GT_AudioEngine_OpenAL

#include <GTGameEngine/Audio/AudioEngine.hpp>
...
namespace GT
{
    ...
    public:
        ...
        void SetListenerPosition(HListener listener, vec3 position);

        /// AudioEngine::GetListenerPosition().
        vec3 GetListenerPosition(HListener listener) const;

        /// AudioEngine::SetListenerOrientation().
        void SetListenerOrientation(HListener listener, const quat &orientation);

        /// AudioEngine::GetListenerOrientation().
        quat GetListenerOrientation(HListener listener) const;
        ...
        void SetSoundPosition(HSound sound, vec3 position);

        /// AudioEngine::GetSoundPosition().
        vec3 GetSoundPosition(HSound sound) const;
