...
namespace GTEngine
{
    ...
    void RCSetTextureState::SetTexture2DData(TextureState_OpenGL21* textureStateIn, GLenum targetIn, int mipmap, GTImage::ImageFormat format, unsigned int width, unsigned int height, const void* data, size_t dataSizeInBytes, bool flip)
    {
        assert((this->textureState == nullptr || (this->textureState == textureStateIn && this->target == targetIn)) && textureStateIn != nullptr);
        {
            this->textureData.mipmapIndex    = mipmap;
            ...
            {
                this->textureData.data = static_cast<GLvoid*>(malloc(dataSizeInBytes));
                GTImage::Utils::CopyImageData(this->textureData.data, data, width, height, format, flip);
            }
            else
            {
                this->textureData.data = nullptr;
    ...
    void RCSetTextureState::SetTexture2DSubData(TextureState_OpenGL21* textureStateIn, GLenum targetIn, int mipmap, GTImage::ImageFormat format, unsigned int xOffset, unsigned int yOffset, unsigned int width, unsigned int height, const void* data, size_t dataSizeInBytes, bool flip)
    {
        assert((this->textureState == nullptr || (this->textureState == textureStateIn && this->target == targetIn)) && textureStateIn != nullptr);
        {
            this->textureData.mipmapIndex    = mipmap;
    ...
    void RCSetTextureState::SetTexture3DData(TextureState_OpenGL21* textureStateIn, GLenum targetIn, int mipmap, GTImage::ImageFormat format, unsigned int width, unsigned int height, unsigned int depth, const void* data, size_t dataSizeInBytes)
    {
        assert((this->textureState == nullptr || (this->textureState == textureStateIn && this->target == targetIn)) && textureStateIn != nullptr);
        {
            this->textureData.mipmapIndex    = mipmap;
    ...
    void RCSetTextureState::SetTextureCubeData(TextureState_OpenGL21* textureStateIn, GTImage::ImageFormat format, unsigned int width, unsigned int height, size_t dataSizeInBytes,
