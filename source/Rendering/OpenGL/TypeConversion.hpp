...
namespace GTEngine
{
    ...
    inline GLint ToOpenGLInternalFormat(GTImage::ImageFormat format)
    {
        switch (format)
        {
    ...
    inline GLenum ToOpenGLFormat(GTImage::ImageFormat format)
    {
        switch (format)
        {
    ...
    inline GLenum ToOpenGLType(GTImage::ImageFormat format)
    {
        switch (format)
        {
        case GTImage::ImageFormat_R8:
