...
namespace GTEngine
{
    ...
    VertexArray * VertexArrayFactory::CreatePlaneXY(float width, float height, VertexFormat &format)
    {
        ...
        if (positionOffset != -1)
        {
            vertex0[positionOffset + 0] = -halfWidth; vertex0[positionOffset + 1] = +halfHeight; vertex0[positionOffset + 2] = 0.0f;
            vertex1[positionOffset + 0] = +halfWidth; vertex1[positionOffset + 1] = +halfHeight; vertex1[positionOffset + 2] = 0.0f;
            vertex2[positionOffset + 0] = +halfWidth; vertex2[positionOffset + 1] = -halfHeight; vertex2[positionOffset + 2] = 0.0f;
            vertex3[positionOffset + 0] = -halfWidth; vertex3[positionOffset + 1] = -halfHeight; vertex3[positionOffset + 2] = 0.0f;
        }
        ...
        if (normalOffset != -1)
        {
            vertex0[normalOffset + 0] = 0.0f; vertex0[normalOffset + 1] = 0.0f; vertex0[normalOffset + 2] = -1.0f;
            vertex1[normalOffset + 0] = 0.0f; vertex1[normalOffset + 1] = 0.0f; vertex1[normalOffset + 2] = -1.0f;
            vertex2[normalOffset + 0] = 0.0f; vertex2[normalOffset + 1] = 0.0f; vertex2[normalOffset + 2] = -1.0f;
            vertex3[normalOffset + 0] = 0.0f; vertex3[normalOffset + 1] = 0.0f; vertex3[normalOffset + 2] = -1.0f;
        }
