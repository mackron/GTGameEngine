...
namespace GTEngine
{
    ...
    {
        cameraNode.Add3DCameraComponent(90.0f, static_cast<float>(16.0f) / static_cast<float>(9.0f), 0.001f, 100.0f);
        ...
        auto modelComponent = modelNode.AddModelComponent(ModelLibrary::LoadFromCollada("models/engine/default.dae"));
        modelComponent->GetModel()->materials[0] = GTEngine::MaterialLibrary::Create("materials/floor.material");
...
namespace GTEngine
{
    ...
    void ModelViewportEventHandler::OnSize(GTGUI::Element &element)
    {
        ...
        camera->Set3DProjection(90.0f, static_cast<float>(newWidth) / static_cast<float>(newHeight), 0.001f, 100.0f);
    }
