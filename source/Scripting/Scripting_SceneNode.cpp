...
namespace GT
{
    bool LoadSceneNodeLibrary(GT::Script &script)
    {
        ...
        (
            ...
            "        for i,scriptRelativePath in ipairs(self._scriptFileRelativePaths) do"
            "            local scriptAbsolutePath = GT.IO.FindAbsolutePath(scriptRelativePath);"
            "            if scriptAbsolutePath then"
            "                self:LinkToScript(GTEngine.ScriptDefinitions[scriptAbsolutePath], scriptRelativePath);"
