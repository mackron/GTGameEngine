...
namespace GT
{
    ...
    namespace AudioFFI
    {
        ...
        int SetListenerPosition(GT::Script &script)
        {
            ...
            g_Context->GetSoundWorld().SetListenerPosition(pos.x, pos.y, pos.z);
        ...
        int SetListenerOrientation(GT::Script &script)
        {
            ...
            g_Context->GetSoundWorld().SetListenerOrientation(forward.x, forward.y, forward.z, up.x, up.y, up.z);
