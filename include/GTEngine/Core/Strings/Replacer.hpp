    ...
    namespace Strings
    {
        ...
        */
        ...
        public:
            ...
            *       The base string is not copied straight away. A copy is only made after the first call to Replace().
            */
            void SetBase(const T* baseIn, ptrdiff_t baseSizeInTsIn = -1)
            {
                m_base         = baseIn;
                m_baseSizeInTs = baseSizeInTsIn;
            }
            ...
            */
            ...
            {
                return Replace(original, -1, replacement, -1);
            }
            ...
            */
            const T* Replace(T original, T replacement)
            {
                ...
                return Replace(originalStr, 1, replacementStr, 1);
            }
