...
namespace GTEngine
{
    ...
    public:
        ...
        /// Retrieves a reference to the weight at the given index.
              VertexWeightPair & GetWeight(size_t index)       { return this->weights[index]; }
        const VertexWeightPair & GetWeight(size_t index) const { return this->weights[index]; }


        /// Retrieves a constant pointer to the internal buffer containing the vertex/weight pairs.
        const VertexWeightPair* GetWeightsBuffer() const
        {
