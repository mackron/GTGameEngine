...
namespace GTEngine
{
    ...
    public:
        ...
        /// @param mousePosX [in, out] The position of the mouse on the X axis, relative to the left of the game viewport.
        /// @param mousePosY [in, out] The position of the mouse on the Y axis, relative to the top of the game viewport.
        virtual bool OnMouseButtonDown(GTCore::MouseButton &button, int &mousePosX, int &mousePosY);
        ...
        /// @param mousePosX [in, out] The position of the mouse on the X axis, relative to the left of the game viewport.
        /// @param mousePosY [in, out] The position of the mouse on the Y axis, relative to the top of the game viewport.
        virtual bool OnMouseButtonUp(GTCore::MouseButton &button, int &mousePosX, int &mousePosY);
        ...
        /// @param mousePosX [in, out] The position of the mouse on the X axis, relative to the left of the game viewport.
        /// @param mousePosY [in, out] The position of the mouse on the Y axis, relative to the top of the game viewport.
        virtual bool OnMouseButtonDoubleClick(GTCore::MouseButton &button, int &mousePosX, int &mousePosY);
        ...
        virtual bool OnKeyPressed(GTCore::Key &key);
        
        /// Called when a key is released.
        ///
        /// @param key [in, out] The key code for the key that was just released.
        virtual bool OnKeyReleased(GTCore::Key &key);
        ...
        /// @remarks
        ///     The difference between this and OnKeyDown() is that OnKeyPressed() does not handle auto-repeat.
        virtual bool OnKeyDown(GTCore::Key &key);
        
        /// Called when a key is released.
        ///
        /// @param key [in, out] The key code for the key that was just released.
        virtual bool OnKeyUp(GTCore::Key &key);
