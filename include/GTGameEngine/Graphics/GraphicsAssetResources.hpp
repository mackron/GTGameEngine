...
namespace GT
{
    ...
    private:
        ...
        GTLib::Vector<GraphicsAssetResource_Texture*> m_textures;

        /// The input texture mappings. The value is an index into m_textures.
        GTLib::Dictionary<size_t> m_inputTextures;

        /// The property texture mappints. The value is an index into m_textures.
        GTLib::Dictionary<size_t> m_propertyTextures;
    };
    ...
    private:
        ...
        GTLib::Vector<GraphicsAssetResource_Material*> m_materials;
    };
    ...
    private:
        ...
        GTLib::Vector<GraphicsAssetResource_Mesh*> m_meshes;
    };
}
