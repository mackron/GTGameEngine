...
namespace GT
{
    ...
    private:
        ...
        HAudioBuffer m_hBuffers[2];


        /// A pointer to the streamer to load the audio data from.
        SoundStreamer* m_streamer;

        /// A pointer to the thread that is playing the sound. This is lazily initialized.
