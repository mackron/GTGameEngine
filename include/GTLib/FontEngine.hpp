...
#ifndef GTLib_FontEngine
#define GTLib_FontEngine
...
namespace GTLib
{
    ...
    public:
        ...
        ///
        /// @param hGlyphMap [in] The glyph map whose image data is being mapped.
        ///
        ...
        ///
        /// @param hGlyphMap [in] the glyph map whose image data is being unmapped.
