...
namespace GT
{
    ...
    struct GUISurface
    {
        ...
        /// The render buffer created by the renderer. This is where the pixel data is stored. Accessing the data can be done with mapping.
        HGUIRenderBuffer renderBuffer;
