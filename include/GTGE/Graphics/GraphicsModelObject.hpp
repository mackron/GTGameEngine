...
namespace GT
{
    ...
    public:
        ...
        bool Initialize(const GraphicsAssetResource_Model* pModelResource, GraphicsWorld* pGraphicsWorld, const glm::vec4 &position, const glm::quat &rotation, const glm::vec4 &scale);
        ...
        void SetTransform(const glm::vec4 &position, const glm::quat &rotation, const glm::vec4 &scale);
