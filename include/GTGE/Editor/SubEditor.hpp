...
namespace GT
{
    ...
    public:
        ...
        /// Retrieves the tab GUI element associated with this editor.
              GUIElement* GetTabElement()       { return m_tabElement; }
        const GUIElement* GetTabElement() const { return m_tabElement; }
        ...
        virtual       GUIElement* GetMainElement()       { return nullptr; }
        virtual const GUIElement* GetMainElement() const { return nullptr; }
